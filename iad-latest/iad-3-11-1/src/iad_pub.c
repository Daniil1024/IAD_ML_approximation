...
{
  double default_sphere_d = 50;    // 8.0 * 25.4;
  double default_sample_d = 9.9;   // 0.0 * 25.4;
  double default_detector_d = 0.2; // 0.1 * 25.4;
  double default_entrance_d = 4.9; // 0.5 * 25.4;
  ...
  m->slab_cos_angle = cos(8 * 3.1415926 / 180);
