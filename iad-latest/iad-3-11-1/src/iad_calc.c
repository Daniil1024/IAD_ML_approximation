...
Gain_11(struct measure_type m, double URU, double tdiffuse)
{
  ...
  G11 =
      G / (1 -
           m.as_r * m.as_t * m.aw_r * m.aw_t * (1 - m.ae_r) * (1 - m.ae_t) * G *
             ...
             double UR1, double URU, double UT1, double UTU)
{
  ...
  x *=
      (1 - m.f_r) * UR1 + m.rw_r * m.f_r + (1 - m.f_r) * m.as_t * (1 - m.ae_t) * m.rw_t * UT1 * UTU * GP;
  return x;
}
             ...
             double UR1, double URU, double UT1, double UTU)
{
  ...
  x *=
      (1 - m.f_r) * UT1 + (1 -
                           m.ae_r) *
                              m.rw_r * m.as_r * UTU * (m.f_r * m.rw_r + (1 - m.f_r) * UR1) *
                              G;
  return x;
}
                                         ...
                                         double *M_R, double *M_T, double *dev)
{
  ...
  case -2:
    ...
    {
      *M_R =
          (1 - MM.f_r) * R_direct / ((1 - MM.f_r) + MM.f_r * MM.rw_r / MM.rstd_r);
      *M_T = T_direct;
    }
